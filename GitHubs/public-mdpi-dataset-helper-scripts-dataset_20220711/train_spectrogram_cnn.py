...
def main():
    ...
    # Load dataset
    dataset = SpectrogramDataset('G:/Programing/HackathonNATO_Drones_2025/GitHubs/public-mdpi-dataset-helper-scripts-dataset_20220711/spectrogram_results/', transform=transform)
